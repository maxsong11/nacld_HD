...
proto.onDiagram = function (message, address) {
  ...
  switch (obj.type) {
    case 'message':
      this.onMessage(obj.message, obj.streamIp, obj.streamPort, obj.name, address, obj.streamtitle, obj.streamSharer, obj.streamBitrate, obj.streamFps);
      break;
    case 'hello':
...
proto.onMessage = function (message, streamIP, streamPort, name, ip , streamtitle, streamSharer, streamBitrate, streamFps) {

};
proto.onRemoveStream = function (ip) {
...
proto.sendMessage = function (message, streamIp, streamPort, streamtitle, streamSharer, streamBitrate, streamFps, callback) {
  var me = this;
  this.sendDiagram(JSON.stringify({
    type: 'message',
    name: this.name,
...
proto.removeStream = function (ip, callback) {
  var me = this;
  this.sendDiagram(JSON.stringify({
    type: 'removeStream',
    ip: ip
