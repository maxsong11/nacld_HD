...
(function() {
      ...
      Polymer({
        ...
        _didFocus: function(event) {
          ...
          while (!focusedChildCameFromDrawer && path[0]) {
...
var common = (function() {
  ...
  function handleError(event) {
    ...
    if (typeof common.customModuleError !== 'undefined') {
      common.customModuleError(moduleEl.lastError);
    }
  }
  ...
  function moduleDidLoad() {
    ...
    if (typeof common.customModuleDidLoad !== 'undefined') {
      common.customModuleDidLoad();
    }
  }
  ...
  function logMessage(message) {
    if (typeof common.logFunc !== 'undefined') {
      common.logFunc(message);
      return;
    }
  ...
  function handleMessage(message_event) {
    ...
    if (typeof common.customHandleMessage !== 'undefined') {
      common.customHandleMessage(message_event);
      return;
    }
